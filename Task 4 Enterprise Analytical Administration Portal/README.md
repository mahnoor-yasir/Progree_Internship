...
| 🛠️ Tech Stack | All technologies used |
| 📁 Structure | Complete folder structure |
| 🚀 Quick Start | How to run the project |
| 🔐 Credentials | Demo login details |
| 📊 Dashboard | KPI cards, charts, data grid |
| 🗃️ CRUD | All operations explained |
| 🎨 Theme | Dark/light mode customization |
| 👥 Users | User management features |
| 📑 Reports | Report generation and export |
| 📈 Analytics | Charts and filters |
| 🎯 Help | Tutorials, docs, support, FAQs |
